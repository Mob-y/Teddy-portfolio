...
// --- CONFIG DES ANIMATIONS DE FLOTTEMENT ---
...
export default function App() {
  ...
  const toggleMode = () => {
    new Audio("/sounds/dash.wav").play().catch(() => {});
    setIsDashing(true);
  ...
  return (
      ...
      animate={
        isDashing
          ? {
              x: [-20, 20, -15, 15, 0],
              filter: [
                "brightness(2) contrast(1.5) hue-rotate(90deg)",
    ...
    >
      ...
      <header className="relative py-32 px-8 max-w-6xl mx-auto text-center z-10">
        <h1
          className="text-8xl md:text-[10rem] leading-none uppercase drop-shadow-md"
          style={{ color: theme.primary }}
        >
          Teddy Serin
        </h1>
        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="max-w-4xl w-full border-8 p-8 flex flex-col items-center shadow-2xl"
            ...
            >
              ...
              <img
                ...
                className="max-h-[40vh] border-4 mb-6 shadow-md"
                style={{
                  imageRendering: "pixelated",
                  borderColor: theme.cardBorder,
                }}
              />
              <h2 className="text-5xl md:text-6xl uppercase font-bold text-center mb-4">
                {selectedProject.title}
              </h2>
              <p className="text-2xl opacity-70 uppercase mb-8 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {selectedProject.link && selectedProject.link !== "#" && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-2xl px-10 py-3 uppercase font-bold text-white transition-transform hover:scale-105 shadow-md"
                    style={{ backgroundColor: theme.primary }}
                  >
                    🔗 Voir le site
                  </a>
                ...
                {selectedProject.github && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-2xl px-10 py-3 uppercase font-bold border-4 transition-transform hover:scale-105 shadow-md"
